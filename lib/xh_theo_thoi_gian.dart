...
class XepHangTheoTG extends StatefulWidget {
  const XepHangTheoTG({Key? key}) : super(key: key);

  @override
  State<XepHangTheoTG> createState() => _XepHangTheoTGState();
}

class _XepHangTheoTGState extends State<XepHangTheoTG> {
  String ten = "";
  @override
  void initState() {
    super.initState();
