...
class XepHangTheoLV extends StatefulWidget {
  const XepHangTheoLV({Key? key}) : super(key: key);

  @override
  State<XepHangTheoLV> createState() => _XepHangTheoLVState();
}

class _XepHangTheoLVState extends State<XepHangTheoLV> {
  String ten = "";
  @override
  void initState() {
    super.initState();
